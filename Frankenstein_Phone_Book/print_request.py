...
def print_all():  # запись данных из всех файлов в отдельный фаил Phonebook_general.csv
    file = 'Phonebook_general.csv'
        ...
        if path.exists(file_csv) and path.exists(file_txt):
            with open(file_csv, 'r', encoding='utf-8') as text_csv,\
                ...
                for i, v in enumerate(t_txt):
                    text.write(f'{v.strip()}\n')
                print('Все данные успешно занесены в фаил Phonebook_general.csv')